...
int takeoff2(float takeoff_alt)
{
	//intitialize first waypoint of mission
	set_destination(0,0,takeoff_alt,0);
	for(int i=0; i<100; i++)
...
*/
int check_waypoint_reached(float pos_tolerance=0.06, float heading_tolerance=0.01)
{
	local_pos_pub.publish(waypoint_g);
...
{
  std::string ros_namespace = controlnode.getNamespace(); 
