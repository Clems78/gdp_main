...
std::vector<TargetPoint> waypoints = {
    ...
    {-35.3633, 149.16523, 603.7887287},     //North 1
};
...
int main(int argc, char **argv) {
    ros::init(argc, argv, "drone_1");
    ros::NodeHandle nh;
    initialize_local_frame();

    init_publisher_subscriber(nh);

    ros::Subscriber position_sub_drone1 = nh.subscribe("/mavros/global_position/global", 10, globalPositionCallbackDrone1);
